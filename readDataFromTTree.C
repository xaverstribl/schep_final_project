...
int readDataFromTTree(const char* filename) {
	...
	// // create histograms
	TH1F *histProton = new TH1F("histProton","p_T (Proton)",400,0,30);
	TH1F *histPion = new TH1F("histPion","p_T (Pion)",400,0,30);
	TH1F *histKaon = new TH1F("histKaon","p_T (Kaon)",400,0,30);
